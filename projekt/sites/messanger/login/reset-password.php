...
$new_password_err = $old_password_err = $confirm_password_err = "";
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    } elseif ($_POST["old_password"] == $_SESSION["password"]) {
        $old_password_err = "";
    } else {
        $old_password_err = "Password did not match with your old one!";
    }
